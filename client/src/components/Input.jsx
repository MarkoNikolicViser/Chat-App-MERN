...
export const Input = (props) => {
    const { label, required, type, disable, placeholder, value, Function, name } = props
    ...
    return (
        <div className='flex flex-col items-start mb-5 w-full'>
            ...
            <div className='relative w-full'>
                <input
                    id={label}
                    className={`appearance-none relative block h-10 w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 text-xs`}
                    value={value}
